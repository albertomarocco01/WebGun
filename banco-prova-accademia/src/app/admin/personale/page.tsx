...
const RUOLI = [
  { valore: "direttore", testo: "Direttore" },
  { valore: "segreteria", testo: "Segreteria" },
  { valore: "insegnante", testo: "Insegnante" },
];
...
export default async function Personale() {
  ...
  return (
    <section className="flex flex-col gap-8">
      ...
      <Tabella
        didascalia="Personale dell&apos;accademia, con il ruolo assegnato"
        ...
        <article key={p.id} className="border-t border-slate-200 pt-4">
          ...
          <Modulo azione={aggiornaRecapiti}>
            ...
            <Campo
              ...
              valore={p.full_name}
            />
            <Campo nome="phone" suffisso={p.id} etichetta="Telefono" valore={p.phone} />
