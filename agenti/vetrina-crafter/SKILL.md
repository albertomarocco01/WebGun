...
| **E — slot rinominato o non più pubblicato** | la pagina chiede una chiave che non esiste e mostra il vuoto, **e i tipi non dicono niente**: una chiave di slot è una stringa | `contenuti-vivi`, regola 1 e la sua premessa: slot senza riga pubblicata = MANCANTE, valore che non compare in pagina = `block` |
