...
- **Stato attuale:** v1.0 — skill vera, collaudata su un progetto Next.js + Supabase reale (banco `banco-prova-negozio`, e-commerce di maglieria) il 2026-07-28. Gli script hanno test propri (`node --test`, **105 verdi**), il gate `verify` ha **7 passi** e l'audit **sei regole** con nove verdetti distinti.
