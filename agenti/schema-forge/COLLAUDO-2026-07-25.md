...
> **Stato: chiuso.** Tutti e otto i punti del §Report finale sono stati corretti il **2026-07-26** — vedi `STATO.md` §Correzioni del 2026-07-26. Questo documento resta com'era: è il verbale del collaudo, non la lista dei lavori. Due precisazioni emerse applicando le correzioni: `-- squawk-ignore <regola>` funziona **solo se sta da solo sulla riga** (qui era scritto «con la motivazione accanto» — accanto non funziona, squawk legge il resto come altri nomi di regola), e il gate soffriva di due bug più gravi di quelli elencati qui, che questo collaudo **non** ha trovato perché il banco era troppo semplice: l'audit RLS crashava su ogni policy con una sottoquery, e girava sul database di un altro progetto.
