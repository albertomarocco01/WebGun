 ...
 * quest'ordine. Il primo, Windows non sa eseguirlo. La regola e' della skill
 * sorella `gestionale-crafter` (`scegliEseguibile`, misurata il 2026-07-28: i
 * passi `tsc` e `a11y` fallivano col DETTAGLIO VUOTO su una macchina dove
 * entrambi gli strumenti funzionano); qui arriva perche' questo gate ora lancia
 * SOLO percorsi pieni, e un percorso pieno sbagliato non ha ricadute.
 */
