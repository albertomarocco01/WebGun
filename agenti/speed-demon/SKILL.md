...
- **`verify`** → `node <skill>/scripts/verify.mjs [--url <url>] [--json]`: i sette passi della §Gate. All'utente riporto **solo il residuo** e le **verifiche mancanti**, mai i log grezzi di Lighthouse.
