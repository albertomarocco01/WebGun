...
| D13 | Il pilota si chiama **`fornodoro`** (pizzeria «Forno d'Oro»), repo `C:\Users\Utente\Desktop\fornodoro`, blocco porte **57620-57629** (api 57621, db 57622) | il piano non fissava né nome né percorso (buco dichiarato dall'istruttoria del 2026-08-04); il blocco 57620-57629 è **misurato libero** da P.4-pre e non collide coi blocchi che i tre banchi tengono prenotati nei loro `config.toml` anche da spenti | presa 2026-08-04 — revocabile finché P.4a non parte |
